...
Common_layer/Src/%.o Common_layer/Src/%.su Common_layer/Src/%.cyclo: ../Common_layer/Src/%.c Common_layer/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32L432xx -c -I../Core/Inc -I../Drivers/STM32L4xx_HAL_Driver/Inc -I../Drivers/STM32L4xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32L4xx/Include -I../Drivers/CMSIS/Include -I"E:/Integration_with_ADC_RTC_GSM_updated/Common_layer/Inc" -I"E:/Integration_with_ADC_RTC_GSM_updated/Application_layer/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"

clean: clean-Common_layer-2f-Src

clean-Common_layer-2f-Src:
	-$(RM) ./Common_layer/Src/Common_GSM.cyclo ./Common_layer/Src/Common_GSM.d ./Common_layer/Src/Common_GSM.o ./Common_layer/Src/Common_GSM.su ./Common_layer/Src/common_RTC.cyclo ./Common_layer/Src/common_RTC.d ./Common_layer/Src/common_RTC.o ./Common_layer/Src/common_RTC.su ./Common_layer/Src/common_adc.cyclo ./Common_layer/Src/common_adc.d ./Common_layer/Src/common_adc.o ./Common_layer/Src/common_adc.su ./Common_layer/Src/ssd1306.cyclo ./Common_layer/Src/ssd1306.d ./Common_layer/Src/ssd1306.o ./Common_layer/Src/ssd1306.su ./Common_layer/Src/ssd1306_fonts.cyclo ./Common_layer/Src/ssd1306_fonts.d ./Common_layer/Src/ssd1306_fonts.o ./Common_layer/Src/ssd1306_fonts.su
